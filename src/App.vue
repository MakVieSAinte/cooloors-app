  ...
  <div class="app" :class="{ dark: isDarkMode }">
    ...
    <div v-if="showPalettesModal" class="modal-overlay" @click.self="showPalettesModal = false">
      <div class="modal-content" style="position: relative;">
        <button class="nav-button" @click="showPalettesModal = false" style="position: absolute; top: 18px; right: 18px; background: none; border: none; box-shadow: none; z-index: 10;" title="Fermer">
...
:root {
  ...
  --hover-color: #f5f5f5;
  --main-font:
    "Karla", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial,
    sans-serif;
}
...
/* Styles pour le menu d'actions de la palette */
